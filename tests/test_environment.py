...
class TestBaseEconomy:
    ...
    def test_compute_reward_at_target(self):
    ...
    def test_compute_reward_with_deviations(self):
    ...
    def test_compute_reward_with_penalty(self):
    ...
    def test_check_termination_target_reached(self):
    ...
    def test_check_termination_max_steps(self):
...
class TestSVAREconomy:
    ...
    def test_initialization(self, svar_economy):
    ...
    def test_reset(self, svar_economy):
    ...
    def test_reset_with_initial_state(self, svar_economy, sample_state):
    ...
    def test_step_shape(self, svar_economy, sample_state):
    ...
    def test_step_state_evolution(self, svar_economy, sample_state):
        ...
        # Check lag structure
        assert next_state[1] == sample_state[0]  # y_{t-1} = y_t
        assert next_state[3] == sample_state[2]  # π_{t-1} = π_t
        assert next_state[4] == action           # i_{t-1} = i_t
        assert next_state[5] == sample_state[4]  # i_{t-2} = i_{t-1}
    
    def test_step_deterministic(self, svar_params, seed):
    ...
    def test_predict_deterministic(self, svar_economy, sample_state):
...
class TestANNEconomy:
    ...
    def test_step_shape(self, ann_economy, sample_state):
        """Test step returns correct shapes."""
        action = 3.5
    ...
    def test_networks_called(self, ann_economy, sample_state):
    ...
    def test_predict_deterministic(self, ann_economy, sample_state):
...
class TestEnvironmentConsistency:
    ...
    def test_same_interface(self, svar_economy, ann_economy, sample_state):
    ...
    def test_reward_consistency(self, svar_economy, ann_economy):
